<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMa.Master" AutoEventWireup="true" CodeBehind="PanelReportes.aspx.cs" Inherits="CapaPresentacion.PanelReportes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="card-body">
        <div class="form-row align-items-end" id="omitirep">
            ...
            <div class="form-group col-sm-3">
                <button class="btn btn-info btn-block btn-sm" type="button" id="btnImprimir"><i class="fas fa-print"></i> Reporte</button>
             </div>
        </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="jsfro/PanelReportes.js" type="text/javascript"></script>
</asp:Content>
